...
class PowerOff(Resource):
    ...
    @swagger.operation(
        notes='API to Power Off a specific Port of PDU',
        nickname='power_off',
        parameters=[
            {
                'name': 'body',
                'description': "API to Power Off a specified Port",
                'required': False,
                'allowMultiple': False,
                'dataType': PowerOffModel.__name__,
                'paramType': 'body'
            }
        ],
        responseMessage=[
    ...
    def post(self):
        ...
        try:
            ...
            response = self._pdu_library_manager.power_off(args.manufacturer,
                                                           args.ip,
                                                           args.username,
                                                           args.password,
                                                           args.port)
