...
class Reboot(Resource):
    ...
    @swagger.operation(
        notes='API to Reboot a specific Port of PDU',
        nickname='reboot',
        parameters=[
            {
                'name': 'body',
                'description': "API to Reboot a specified Port",
                'required': False,
                'allowMultiple': False,
                'dataType': RebootModel.__name__,
                'paramType': 'body'
            }
        ],
        responseMessage=[
    ...
    def post(self):
        ...
        try:
            ...
            response = self._pdu_library_manager.reboot(args.manufacturer,
                                                        args.ip,
                                                        args.username,
                                                        args.password,
                                                        args.port)
